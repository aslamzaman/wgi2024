...
const Delivery = () => {
    ...
    const [searchText, setSearchText] = useState('28526702');
    ...
    const printHandler = (id) => {
        ...
        doc.line(20, 100, 20, y + 19); // Vertical Line
        doc.line(94, 100, 94, y + 19); // Vertical Line
        doc.line(117, 100, 117, y + 19); // Vertical Line
        doc.line(140, 100, 140, y + 19); // Vertical Line
        doc.line(160, 100, 160, y + 19); // Vertical Line
        doc.line(190, 100, 190, y + 19); // Vertical Line
