                ...
                <table className="w-full border border-gray-200">
                    <thead>
                        <tr className="w-full bg-gray-200">                           
                                  ...
                                  <th className="text-center border-b border-gray-200 px-4 py-2">Invoiceno</th>
                        ...
                        {invoices.length ?(
                            invoices.map(invoice => (
                                <tr className="border-b border-gray-200 hover:bg-gray-100" key={invoice._id}>                                           
                                          <td className="text-center py-2 px-4">{invoice.dt}</td>
                                          <td className="text-center py-2 px-4">{invoice.invoiceno}</td>
                                          <td className="text-center py-2 px-4">{invoice.shipment}</td>
                                          <td className="text-center py-2 px-4">{invoice.customer}</td>
                                          <td className="text-center py-2 px-4">{invoice.item}</td>
                                    ...
                                    <td className="flex justify-end items-center space-x-1 mt-1 mr-2">
                                        <Edit message={messageHandler} id={invoice._id} data={invoices} />
