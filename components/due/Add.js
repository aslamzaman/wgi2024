...
const Add = ({ message, id }) => {
    ...
    return (
        <>
                ...
                <div className="fixed inset-0 py-16 bg-black bg-opacity-30 backdrop-blur-sm z-10 overflow-auto">
                    <div className="w-11/12 md:w-1/2 mx-auto mb-10 bg-white border-2 border-gray-300 rounded-md shadow-md duration-300">
                        <div className="px-6 md:px-6 py-2 flex justify-between items-center border-b border-gray-300">
                            ...
                            <button onClick={closePaymentForm} className="w-8 h-8 p-0.5 bg-gray-50 hover:bg-gray-300 rounded-md transition duration-500">
                        ...
                        <div className="px-6 pb-6 text-black">
                            <form onSubmit={saveHandler}>
                                ...
                                <div className="w-full flex justify-start">
                                    <input type="button" onClick={closePaymentForm} value="Close" className="bg-pink-600 hover:bg-pink-800 text-white text-center mt-3 mx-0.5 px-4 py-2 font-semibold rounded-md focus:ring-1 ring-blue-200 ring-offset-2 duration-300 cursor-pointer" />
            ...
            <button onClick={showPaymentForm} title="Payments" className="w-7 h-7 flex justify-center items-center">
